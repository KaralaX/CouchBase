...
[IterationCount(5)]
[CsvExporter]
public class BenchMarkSequentialOperations
{
    ...
    public async Task SequentialWrite()
    {
        ...
        await operation.SequentialWrite(noOperations, TestId, document);
    }
    ...
    public async Task SequentialRead()
    {
        ...
        await operation.SequentialRead(noOperations, TestId);
    }
